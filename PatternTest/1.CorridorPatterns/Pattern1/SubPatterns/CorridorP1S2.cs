...
namespace SmallHousing.CorridorPatterns
{
    ...
    {
        class CorridorP1S2 : ICorridorP1Sub
        {
            //field
            ...
            public List<Polyline> Build()
            {
                ...
                Point3d anchor2 = DrawAnchor2(anchor1, Core, AxisSet[0]);
                Point3d anchor3 = DrawAnchor3(anchor2, Outline, AxisSet[0], Core.BaseLine);
                Point3d anchor4 = DrawAnchor4(anchor3, Outline, AxisSet[0], Param[0]);
